...
Usage of kube2iam:
      ...
      --use-api-on-cache-issues               Queries the k8s API server to find the source of truth when the pod cache doesn't contain a match or contains multiple pods with the same IP
